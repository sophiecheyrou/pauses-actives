...
P('RESPIRER','Carré respiratoire',50,'◻️','Inspire · pause · expire · pause.','Même respiration, sans forcer.','videos/respiration-carree-evaluation.mp4','audio/respiration-3-4.mp3'),
...
P('RESPIRER','Souffle calme',50,'🌬️','Respirer naturellement.','Posture confortable.','videos/souffle-calme-evaluation.mp4','audio/respiration-calme.mp3')]},
...
P('APPRENDRE','Prendre son pouls',30,'❤️','Pose doucement 2 doigts sur un seul côté du cou, sous la mâchoire. Cherche tes pulsations cardiaques','','videos/pouls-apprendre.mp4','audio/recre-apprendre-pouls.mp3'),
P('MESURER','1re mesure – 30 s',30,'⏱️','Compte chaque pulsation cardiaque pendant 30 secondes.','','videos/pouls-mesure-1.mp4','audio/recre-mesure-1.mp3'),
P('MÉMORISER','Mon repère de départ',15,'🧠','Retiens ton nombre de pulsations cardiaques.','','videos/pouls-memoriser.mp4','audio/recre-memoriser.mp3'),
...
P('MESURER','2e mesure – 30 s',30,'⏱️','Reprends ton pouls de la même façon. Compte les pulsations cardiaques pendant 30 secondes.','','videos/pouls-mesure-2.mp4','audio/recre-mesure-2.mp3'),
...
P('SOUFFLE','Respiration calme',40,'🌬️','Respirer lentement.','Épaules relâchées.','videos/respiration-calme-fin-journee.mp4','audio/respiration-calme.mp3'),
