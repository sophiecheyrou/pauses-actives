...
{cat:'MOVE',title:'Besoin de se défouler',tag:'Dynamique et défoulant',intensity:3,steps:[P('TECHNIQUE','Directs',70,'👊','Droite. Gauche. Droite. Gauche.','Identique assis.','videos/besoin-de-se-defouler-02-directs.mp4','audio/besoin-de-se-defouler-02-directs.mp3'),P('TECHNIQUE','Double direct',40,'🥊','Droite-gauche… pause… droite-gauche.','Identique assis.','videos/besoin-de-se-defouler-03-double-direct.mp4','audio/besoin-de-se-defouler-03-double-direct.mp3'),P('COORDINATION','Direct + esquive',40,'↙️','Deux directs puis légère flexion.','Deux directs puis légère inclinaison.','videos/besoin-de-se-defouler-04-direct-esquive.mp4','audio/besoin-de-se-defouler-04-direct-esquive.mp3'),P('TECHNIQUE','Uppercuts',40,'⬆️','Alterne les bras de bas en haut. Sans forcer.','Identique assis.','videos/besoin-de-se-defouler-05-uppercuts.mp4','audio/besoin-de-se-defouler-05-uppercuts.mp3'),P('COMBO','Droite-gauche-droite-esquive',50,'🔥','Enchaîne : droite, gauche, droite, esquive.','Même combo assis.','videos/besoin-de-se-defouler-06-droite-gauche-droite-esquive.mp4','audio/besoin-de-se-defouler-06-droite-gauche-droite-esquive.mp3'),P('CHALLENGE','Classe synchro',30,'🎯','Toute la classe ensemble. Ne perdez pas le rythme !','Identique assis.','videos/besoin-de-se-defouler-07-classe-synchro.mp4','audio/besoin-de-se-defouler-07-classe-synchro.mp3'),P('RESET','Relâche',30,'🌬️','Ouvre les mains. Secoue les bras. Inspire. Souffle.','Identique assis.','videos/besoin-de-se-defouler-08-relache.mp4','audio/besoin-de-se-defouler-08-relache.mp3')]},
{cat:'FOCUS',title:'Avant un exercice',tag:'Coordination & attention',intensity:2,steps:[P('COORDINATION','Même côté',30,'✋','Main droite sur genou droit. Puis gauche.','Identique assis.','videos/avant-un-exercice-01-meme-cote.mp4','audio/avant-un-exercice-01-meme-cote.mp3'),P('COORDINATION','Croisé main-genou',40,'✕','Main droite sur genou gauche. Puis inverse.','Identique assis.','videos/avant-un-exercice-02-croise-main-genou.mp4','audio/avant-un-exercice-02-croise-main-genou.mp3'),P('COORDINATION','Coude-genou opposé',40,'🧠','Coude droit vers genou gauche. Puis inverse.','Identique assis.','videos/avant-un-exercice-03-coude-genou-oppose.mp4','audio/avant-un-exercice-03-coude-genou-oppose.mp3'),P('RYTHME','Deux croisés + clap',40,'👏','Deux touches croisées puis un clap.','Identique assis.','videos/avant-un-exercice-04-deux-croises-clap.mp4','audio/avant-un-exercice-04-deux-croises-clap.mp3'),P('RYTHME','Trois marches + clap',40,'🚶','Trois marches sur place puis clap.','Trois tapotements puis clap.','videos/avant-un-exercice-05-trois-marches-clap.mp4','audio/avant-un-exercice-05-trois-marches-clap.mp3'),P('SÉQUENCE','Croisé-croisé-clap-pause',50,'🎯','Enchaîne sans perdre la séquence.','Identique assis.','videos/avant-un-exercice-06-croise-croise-clap-pause.mp4','audio/avant-un-exercice-06-croise-croise-clap-pause.mp3'),P('CHALLENGE','Sans erreur',30,'🧠','Tiens 30 secondes. Si tu te trompes, reprends immédiatement.','Identique assis.','videos/avant-un-exercice-07-sans-erreur.mp4','audio/avant-un-exercice-07-sans-erreur.mp3'),P('RESET','Regard fixe',30,'👁️','Fixe un point et ralentis ta respiration.','Identique assis.','videos/avant-un-exercice-08-regard-fixe.mp4','audio/avant-un-exercice-08-regard-fixe.mp3')]},
...
const MEDIA_VERSION='v23t-20260922-sans-mise-en-garde';
...
function checkPlayfulSurprises(){
  ...
  if(title==='Besoin de se défouler'){
    if(stepIndex===1 && elapsed>=15) showSurprise('defouler-boost','🔥','BOOST 20 s','On accélère !','boost',20);
    if(stepIndex===2 && elapsed>=20) showSurprise('defouler-freeze','🧊','FREEZE !','Tout le monde immobile pendant 5 secondes !','freeze',10);
    if(stepIndex===4 && elapsed>=15) showSurprise('defouler-turbo','⚡','TURBO 15 s','Accélère tes mouvements tout en restant précis !','turbo',15);
    if(stepIndex===5 && elapsed>=2) showSurprise('defouler-synchro','🎯','SYNCHRO 30 s','Toute la classe ensemble, exactement au même rythme !','synchro',28);
  }
}
